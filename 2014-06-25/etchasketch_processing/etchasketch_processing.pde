/*
 ...
 modified Jun 2014 for fun by Pearl Chen
...
// Store the last 1024 values from the sensors so we can draw them.
int[] valuesx = new int[1024];
int[] valuesy = new int[1024];
